...
|[Codeforces](https://codeforces.com/)| Sim | Não | C, C++, Java, Python, Kotlin, C#, Go, Rust, Ruby, Pascal, Haskell, e mais | Plataforma de programação competitiva; tem concursos regulares chamados "Contests"; comunidade ativa e fórum de discussão; ótimo para treino de algoritmos e entrevistas técnicas |
